...
<body>
    ...
    <nav class="sidebar">
        ...
        <ul class="nav-links">
            ...
            <a href="{{ route('admin.reportes-usuarios') }}"><li><i class="fas fa-user"></i><span>Reporte de usuarios</span></li></a>
            <a href="{{ route('libros.index') }}"><li><i class="fas fa-book"></i><span>Reporte de libros</span></li></a>
            <a href="{{ route('admin.perfil') }}"><li class="active"><i class="fas fa-user-circle"></i><span>Perfil</span></li></a>
        </ul>
    </nav>
    ...
    <main class="main-content">
        ...
        <section class="perfil-usuario">
            ...
            <div class="contenedor-info">
                <p><strong>Correo:</strong> duransantiago003@gmail.com</p>
                <p><strong>Ubicación:</strong> Bogotá, barrio Mandalay</p>
                <p><strong>Ciudad:</strong> Bogotá</p>
                <p><strong>Dirección:</strong> Calle 15 #12-34</p>
                

                <!-- Botón de editar -->
                <button class="boton-editar"><i class="fa-solid fa-pen"></i> Editar información</button>
            </div>
