...
<body>
    <button id="modoToggle" class="modo-toggle">☀️ Modo Claro</button>
    <div class="contenedor-error">
        <h1>500</h1>
        <h2>Error del servidor</h2>
        <p>Algo salió mal en nuestro servidor. Por favor, intenta de nuevo más tarde.</p>
        <a href="../html/dashboard_admin.html" class="boton">Volver al inicio</a>
    </div>
    <script>
        ...
        botonModo.addEventListener("click", () => {
            ...
            botonModo.textContent = esClaro ? "🌙 Modo Oscuro" : "☀️ Modo Claro";
